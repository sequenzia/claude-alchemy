...
This reference provides detailed verification approaches for both PRD-generated and general tasks, including task classification detection, criterion evaluation, and pass/fail determination.
...
5. **Check execution context**: Read `.claude/execution-context.md` for any learnings from the previous attempt
