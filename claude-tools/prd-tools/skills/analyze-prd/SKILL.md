---
name: analyze-prd
description: Analyze an existing PRD for inconsistencies, missing information, ambiguities, and structure issues. Use when user says "analyze PRD", "review PRD", "PRD quality check", "validate requirements", "audit PRD", or "check PRD quality".
