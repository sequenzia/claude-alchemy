...
- **Empty task list**: Report "No tasks found. Use `/prd-tools:create-tasks` to generate tasks from a PRD, or create tasks manually with TaskCreate." and stop.
...
```
Task:
  subagent_type: prd-tools:task-executor
  prompt: |
