...
1. Check for `**Acceptance Criteria:**` in description → PRD-generated
2. Check for `metadata.prd_path` → PRD-generated
3. Check for `Source:` reference → PRD-generated
