...
Execute a structured exploration + synthesis workflow using Agent Teams with hub-and-spoke coordination. The lead performs rapid reconnaissance to generate dynamic focus areas, workers explore independently, and a synthesizer merges findings with Bash-powered investigation.
...
6. **Spawn teammates:**
   ...
   - **3 workers** — `subagent_type: "agent-alchemy-code-explorer"`, model: sonnet
